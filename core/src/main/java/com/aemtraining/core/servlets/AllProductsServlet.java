...
@Component(
        ...
        property = {
                ServletResolverConstants.SLING_SERVLET_RESOURCE_TYPES + "=aemtraining/components/productlist",
                ServletResolverConstants.SLING_SERVLET_METHODS + "=" + HttpConstants.METHOD_GET,
                ServletResolverConstants.SLING_SERVLET_EXTENSIONS + "=json"
        }
)
public class AllProductsServlet extends SlingSafeMethodsServlet {
